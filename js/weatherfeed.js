		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (feed.description != 'Yahoo! Weather Error') {
					...
					html += '<div style="clear:both;"></div><br><div class="weatherTemp">'+ feed.item.condition.temp +'&deg;C</div>';
					
				
					// Add optional data
					if (options.highlow) html += '<br><br><br><br><div class="weatherRange">Nhi&#7879;t &#273;&#7897;: '+wf.low + '&deg;C - '+ wf.high +'&deg;C</div>';
					if (options.wind) html += '<div class="weatherWind">T&#7889;c &#273;&#7897; gi&#243;: '+ feed.wind.speed + feed.units.speed +'</div>';
